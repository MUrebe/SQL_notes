...
select marka_isim , calisan_sayisi , (select sum(maas) as toplam_maas from calisanlar
...
(select max(maas) as mas_maas  from calisanlar where marka_isim = isyeri) ,
