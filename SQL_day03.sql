...
update film set film_ismi='Recep Ivedik'
where film_no=300;
...
update film set film_ismi='Cakallarla Dans',film_turu='Komedi'
where film_no=100;


-- SORU4: film_ismi 'Babam ve Oglum' olan film'in
--film_turu'nu 'Dram' olarak güncelleyiniz.
update film set film_turu='Dram' 
where film_ismi='Babam ve Oglum';
...
insert into memurlar values(1,'Zulal',20000,'Lise');
insert into memurlar values(5,'Altug',25000,'Yuksek Lisans');
